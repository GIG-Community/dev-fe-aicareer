const GACHA_REWARDS = {
  ...
  TRY_AGAIN: { type: 'try_again', name: 'Kesempatan Bonus!', rarity: 'special', probability: 30 },
  PREMIUM: { type: 'premium', name: 'Langganan Premium 1 Bulan gratis', rarity: 'epic', probability: 20 },
};
