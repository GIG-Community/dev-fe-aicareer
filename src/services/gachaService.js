const GACHA_REWARDS = {
  ...
  VOUCHER: { type: 'voucher', name: 'Voucher Diskon dan dapatkan stiker + snack dengan checkout ditempat', rarity: 'Exclusive', probability: 55 },
  ...
  PREMIUM: { type: 'premium', name: 'Langganan Premium 1 Bulan gratis', rarity: 'Legendary', probability: 10 },
};
